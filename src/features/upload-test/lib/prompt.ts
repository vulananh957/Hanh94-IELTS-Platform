...
export function buildExtractionSystemPrompt(input: {
  ...
  return [
    ...
    '3) Include one question object for every numbered item in the paper; do not skip items without visible answers.',
    ...
    '12) IELTS reading/listening objective tests must total 40 question slots. Reading has 3 passages/parts and listening has 4 parts, but question distribution per part must follow the source document; do not assume fixed per-part ranges.',
    '',
